...
my $socket  = '/app/mariadb/mysql.sock';
my $version = '10.4.18';
...
my $ldata   = '/data/mariadb';
my $execdir = '/app/mariadb/bin';
my $bindir  = '/app/mariadb/bin';

# ----------------------------------------------------------------------
# If installed, search for the compiled in directory first (might be "lib64")
# ----------------------------------------------------------------------

my $pkglibdir = fix_path('/app/mariadb/lib',"libmysql/relwithdebinfo",
                         "libmysql/release","libmysql/debug","lib/mysql","lib");

my $pkgincludedir = fix_path('/app/mariadb/include/mysql', "include/mysql", "include");
